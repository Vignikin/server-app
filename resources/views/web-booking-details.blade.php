  ...
  <div class="model-init" style="display: none;">
    ...
    <div class="model-content1" style="display: none;">
           ...
           <img id="mapImage" style="width:513px;height:250px" src="https://maps.googleapis.com/maps/api/staticmap?center={{$request->lat}},{{$request->lng}}&amp;zoom=15&amp;size=600x300&amp;markers=icon:http://maps.google.com/mapfiles/ms/icons/blue-dot.png|{{$request->lat}},{{$request->lng}}&amp;key=AIzaSyA-n6_B74MUzv2walwhMHqyfWqH92J6Nno">
                                 ...
                                 <div class="pick_ups_location" style="padding-top:10px"><div class="left-text">Pickup </div> <div class="pickup_loc_name pickup">{{$request->pickup_address}}</div></div>

                            <div class="pick_ups_location"><div class="left-text">Drop</div> <div class="pickup_loc_name drop">{{$request->drop_address}}</div></div>
                            <div class="vehicle-details">
                            <div class="price-details" style="padding: 10px 0px;">
                            <div class="vehicle-type-text">{{$booking_data[0]->name}} <div class="price-vehicle-desc">{{$booking_data[0]->short_description}}</div></div>
                            ...
                            <div class="fare-breaup-details"><div class="price-details-head">Fare Breakup</div>
                      ...
                      <!--   <div class="fare-breaup-details">
                        ...
                        <div class="goods_types"><div class="goods text">Good type</div><div class="from location text placeholder goods_type">
